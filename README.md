...
| Skill | Best for |
|---|---|
| `/research-squad` | Full orchestrated pipeline |
| `/research-squad:value-analysis` | Problem framing → Learning Agenda; or Research Summary → Value Analysis Document |
| `/research-squad:research-director` | Research planning + synthesis |
| `/research-squad:interview` | Qualitative depth, mental models, JTBD, OST |
...
| `/research-squad:pricing` | Pricing models, cost structure, WTP, competitor benchmarks |
